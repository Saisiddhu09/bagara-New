...
const About = () => {
  return (
    <div className="about-container text-center mt-2 text-white">
      ...
      <p className="mb-4">
        We undertake Vegetarian and Non-Veg catering services for events of all sizes, from intimate baby showers to grand wedding celebrations. 
        Our vegetarian and non-vegetarian packages are designed to leave your guests happy and amazed—without breaking the bank.
      </p>
    </div>
  );
};
